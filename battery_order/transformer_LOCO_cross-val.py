...
plt.tight_layout()
plt.savefig('loco_cv_results_transformer.png', dpi=150, bbox_inches='tight')
print(f"\n📊 Plot saved: loco_cv_results_transformer.png")
...
with open('loco_cv_results_transformer.pkl', 'wb') as f:
    pickle.dump(loco_results, f)
print(f"💾 Results saved: loco_cv_results_transformer.pkl")
