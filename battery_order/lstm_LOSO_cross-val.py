...
plt.tight_layout()
plt.savefig('loso_cv_results_lstm.png', dpi=150, bbox_inches='tight')
print(f"\n📊 Plot saved: loso_cv_results_lstm.png")
...
with open('loso_cv_results_lstm.pkl', 'wb') as f:
    pickle.dump(loso_results, f)
print(f"💾 Results saved: loso_cv_results_lstm.pkl")
