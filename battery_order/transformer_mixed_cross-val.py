...
plt.tight_layout()
plt.savefig('mixed_cv_results_transformer.png', dpi=150, bbox_inches='tight')
print(f"\n📊 Plot saved: mixed_cv_results_transformer.png")
...
with open('mixed_cv_results_transformer.pkl', 'wb') as f:
    pickle.dump(mixed_results, f)
print(f"💾 Results saved: mixed_cv_results_transformer.pkl")
